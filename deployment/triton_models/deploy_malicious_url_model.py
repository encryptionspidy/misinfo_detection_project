...
class MaliciousURLModelDeployer:
    """
    Deploys the malicious URL detection model using Triton Inference Server.
    """

    def __init__(self, model_name='malicious_url_detector', triton_url='localhost:8000', model_repo_path='/models/malicious_url'):
...
if __name__ == "__main__":
    deployer = MaliciousURLModelDeployer()
